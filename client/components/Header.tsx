      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <nav className="md:hidden pb-4 space-y-2 border-t border-border pt-4">
            <Link to="/" className="block px-3 py-2 text-foreground hover:bg-muted rounded-lg">
              Shop
            </Link>
            <a href="#" className="block px-3 py-2 text-foreground hover:bg-muted rounded-lg">
              Categories
            </a>
            <a href="#" className="block px-3 py-2 text-foreground hover:bg-muted rounded-lg">
              About
            </a>
            <Link to="/admin/products" className="block px-3 py-2 text-foreground hover:bg-muted rounded-lg">
              Admin
            </Link>
          </nav>
        )}
